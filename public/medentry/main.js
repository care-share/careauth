    ...
    render: function () {
        ...
        return (
            ...
            <td className='col-xs-1'>
                {/* we need a hidden input because an "unchecked" checkbox will not get submitted with the form...
                        the 2nd input (if checked) will override the 1st */}
                <input type='hidden' value='true' name='not_found' />
